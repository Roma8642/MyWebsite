    ...
    return (
        <div className="w-[70%] md:w-[40%]">
            <Swiper
                ...
                autoplay={{
                    delay: 7000, // 1 second delay
                    disableOnInteraction: false, // Позволяет продолжать автопрокрутку при взаимодействии с слайдером
                }}
                modules={[FreeMode, Pagination, Autoplay]} // Добавляем Autoplay в список модулей
            >
